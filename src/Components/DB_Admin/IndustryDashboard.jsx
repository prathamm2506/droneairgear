...
import IndustryCenter from './AdminCenter/IndustryCenter'
import IndustryRight from './AdminRight/IndustryRight'
const IndustryDashboard = () => {
  ...
  return (
    ...
    <AdminLeft className="left"/>
    <IndustryCenter className="center"/>
    {/* <RightSide /> */}
    {/* <IndustryRight className="left"/> */}
    </div>
