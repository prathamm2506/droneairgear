      ...
      >
        <SwiperSlide>
          <div className="l-maindiv">
            ...
            <Iframe src="https://www.youtube.com/embed/LmEcyQnfpDA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen/>
            </div>
          </div>
        </SwiperSlide>
